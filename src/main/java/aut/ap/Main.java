            ...
            switch (order) {
                ...
                case "R":
                    ...
                    if (repliedEmail != null) {
                        System.out.println("Successfully sent your reply to Milou " + replyCode + ".");
        ...
        while (!submenuOrder.equals("B")) {
            ...
            switch (submenuOrder) {
                case "A":
                    ...
                    break;
                case "U":
                    List<Email> unreadEmailsOption = service.getUnreadEmails(currentUser.getEmail());
                    System.out.println("Unread Milous : ");
                    displayEmails(unreadEmailsOption, "unread");
                    break;
                case "S":
        ...
        if (emails.isEmpty()) {
            ...
            for (Email email : emails) {
                if (type.equals("sent")) {
                    ...
                    System.out.println("Sender: " + email.getSenderEmail() + " - " + email.getSubject() + " (" + email.getCode() + ")" + status);
                }
            }
        }
    }
